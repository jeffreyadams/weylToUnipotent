...
If $G=Sp(2n)$ then $\pi:(\alpha)\mapsto(\alpha,\epsilon)$ where 
$\epsilon(i)=1$ for all $i$ with $c_\alpha(i)>0$.
...
We give an interpretation of the map $\alpha\mapsto(\alpha,\psi_\alpha)$ in Proposition \ref{p:psi}.
...
The map is $\Phi:\CC_\alpha\mapsto \CU_{\alpha,\epsilon}$ where $\epsilon(i)=1$ for all $i$ with $c_\alpha(i)\ne 0$.

...
indicate the twisted class is elliptic.
The labelling of unipotent classes
classes is from \cite{Spa}, page 148 (${}^3D_4$) and page 250 (${}^2E_6$),
followed by (in brackets) 
that of \cite{M1} and \cite{M2}.
Lusztig defines the map $\Phi$  using  the latter notation.

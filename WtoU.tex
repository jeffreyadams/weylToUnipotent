...
${}^2\negthinspace E_6$ we label the conjugacy classes as in
...
classes is from \cite{Spa}, page 148 (${}^3D_4$) and 250 (${}^2E_6$).
Lusztig defines the map $\Phi$ using the labelling of unipotent
classes of \cite{M1} and \cite{M2}. We give the table relating these
labelings of unipotent classes after the diagrams.


[M1] G.Malle, Generalized Deligne-Lusztig characters, J.Algebra 159 (1993), 64-97.
[M2] G.Malle, Green functions for groups of type E 6 and F 4 in characteristic 2, Commun.Algebra
21 (1993), 747-798.
...
\begin{figure}[t]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=.1]{D4_elliptic_twisted.pdf} % first figure itself
        \captionsetup{labelformat=empty}
        \caption{$^2D_4$}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=.19]{E6_elliptic_twisted.pdf} % first figure itself
                \captionsetup{labelformat=empty}
        \caption{$^2E_6$}
    \end{minipage}
  \end{figure}

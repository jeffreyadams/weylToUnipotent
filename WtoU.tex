...
This makes the relationship between Lusztig's function 
between Lusztig's function $\psi_\alpha$ and
Spaltenstein's map $\theta_2$ precise in the cae of classical groups.
...
image of $\Phi$. We present the resulting Hasse diagrams.
...
\centerline{\includegraphics[scale=.28]{E8_elliptic.pdf}}
